...
class KalturaAccessControlPlayReadyPolicyAction(KalturaRuleAction):
    ...
    def fromXml(self, node):
        ...
        self.fromXmlImpl(node, KalturaAccessControlPlayReadyPolicyAction.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaRuleAction.toParams(self)
        kparams.put("objectType", "KalturaAccessControlPlayReadyPolicyAction")
...
class KalturaPlayReadyClientPlugin(KalturaClientPlugin):
    ...
    def getTypes(self):
        return {
            ...
            'KalturaAccessControlPlayReadyPolicyAction': KalturaAccessControlPlayReadyPolicyAction,
