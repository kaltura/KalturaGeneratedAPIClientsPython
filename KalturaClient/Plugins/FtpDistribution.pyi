...
class KalturaFtpDistributionProfile(KalturaConfigurableDistributionProfile):
    ...
    def __init__(self,
            ...
            dataContentFilenameXslt: str = NotImplemented,
    ...
    def getDataContentFilenameXslt(self) -> str: ...
    def setDataContentFilenameXslt(self, newDataContentFilenameXslt: str) -> None: ...
