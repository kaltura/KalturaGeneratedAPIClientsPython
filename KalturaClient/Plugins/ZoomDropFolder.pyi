...
class KalturaZoomDropFolder(KalturaDropFolder):
    ...
    def __init__(self,
            ...
            fileProcessingGracePeriod: int = NotImplemented): ...
    ...
    def getFileProcessingGracePeriod(self) -> int: ...
    def setFileProcessingGracePeriod(self, newFileProcessingGracePeriod: int) -> None: ...
