...
class KalturaEntryVendorTaskUnit(KalturaObjectBase):
    ...
    PROPERTY_LOADERS = {
        'unitsUsed': getXmlNodeFloat, 
        'serviceName': getXmlNodeText, 
    }

    def fromXml(self, node):
        KalturaObjectBase.fromXml(self, node)
        self.fromXmlImpl(node, KalturaEntryVendorTaskUnit.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaObjectBase.toParams(self)
        kparams.put("objectType", "KalturaEntryVendorTaskUnit")
        kparams.addFloatIfDefined("unitsUsed", self.unitsUsed)
        kparams.addStringIfDefined("serviceName", self.serviceName)
        return kparams
    ...
    def setServiceName(self, newServiceName):
        self.serviceName = newServiceName
...
class KalturaEntryVendorTask(KalturaObjectBase):
    def __init__(self,
            ...
            externalObjectId = NotImplemented):
        KalturaObjectBase.__init__(self)
        ...
        # @var List[KalturaEntryVendorTaskUnit]
        self.unitsUsedArray = unitsUsedArray
    ...
    PROPERTY_LOADERS = {
        ...
        'unitsUsedArray': (KalturaObjectFactory.createArray, 'KalturaEntryVendorTaskUnit'), 
        ...
        'externalObjectId': getXmlNodeText, 
    }
    ...
    def toParams(self):
        ...
        kparams.addArrayIfDefined("unitsUsedArray", self.unitsUsedArray)
        ...
        kparams.addStringIfDefined("externalObjectId", self.externalObjectId)
        return kparams
    ...
    def getUnitsUsedArray(self):
        return self.unitsUsedArray

    def setUnitsUsedArray(self, newUnitsUsedArray):
        self.unitsUsedArray = newUnitsUsedArray
    ...
    def getExternalObjectId(self):
        return self.externalObjectId

    def setExternalObjectId(self, newExternalObjectId):
        self.externalObjectId = newExternalObjectId
...
class KalturaReachProfile(KalturaObjectBase):
    def __init__(self,
            ...
            labelAdditionForHybridServiceType = NotImplemented,
        ...
        # @var KalturaNullableBoolean
        self.enableHybridModeration = enableHybridModeration
        ...
        # @var KalturaNullableBoolean
        self.autoDisplayHybridCaptionsOnPlayer = autoDisplayHybridCaptionsOnPlayer
        ...
        # @var str
        self.labelAdditionForHybridServiceType = labelAdditionForHybridServiceType
    ...
    PROPERTY_LOADERS = {
        ...
        'enableHybridModeration': (KalturaEnumsFactory.createInt, "KalturaNullableBoolean"), 
        ...
        'autoDisplayHybridCaptionsOnPlayer': (KalturaEnumsFactory.createInt, "KalturaNullableBoolean"), 
        ...
        'labelAdditionForHybridServiceType': getXmlNodeText, 
    ...
    def toParams(self):
        ...
        kparams.addIntEnumIfDefined("enableHybridModeration", self.enableHybridModeration)
        ...
        kparams.addIntEnumIfDefined("autoDisplayHybridCaptionsOnPlayer", self.autoDisplayHybridCaptionsOnPlayer)
        ...
        kparams.addStringIfDefined("labelAdditionForHybridServiceType", self.labelAdditionForHybridServiceType)
    ...
    def getEnableHybridModeration(self):
        return self.enableHybridModeration

    def setEnableHybridModeration(self, newEnableHybridModeration):
        self.enableHybridModeration = newEnableHybridModeration
    ...
    def getAutoDisplayHybridCaptionsOnPlayer(self):
        return self.autoDisplayHybridCaptionsOnPlayer

    def setAutoDisplayHybridCaptionsOnPlayer(self, newAutoDisplayHybridCaptionsOnPlayer):
        self.autoDisplayHybridCaptionsOnPlayer = newAutoDisplayHybridCaptionsOnPlayer
    ...
    def getLabelAdditionForHybridServiceType(self):
        return self.labelAdditionForHybridServiceType

    def setLabelAdditionForHybridServiceType(self, newLabelAdditionForHybridServiceType):
        self.labelAdditionForHybridServiceType = newLabelAdditionForHybridServiceType
...
class KalturaVendorCatalogItemUnitPricing(KalturaObjectBase):
    ...
    PROPERTY_LOADERS = {
        'serviceName': getXmlNodeText, 
        'priceUnit': (KalturaObjectFactory.create, 'KalturaVendorCatalogItemPricing'), 
    }

    def fromXml(self, node):
        KalturaObjectBase.fromXml(self, node)
        self.fromXmlImpl(node, KalturaVendorCatalogItemUnitPricing.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaObjectBase.toParams(self)
        kparams.put("objectType", "KalturaVendorCatalogItemUnitPricing")
        kparams.addStringIfDefined("serviceName", self.serviceName)
        kparams.addObjectIfDefined("priceUnit", self.priceUnit)
        return kparams
    ...
    def getPriceUnit(self):
        return self.priceUnit

    def setPriceUnit(self, newPriceUnit):
        self.priceUnit = newPriceUnit
...
class KalturaAudioDescriptionVendorTaskData(KalturaVendorTaskData):
    ...
    def fromXml(self, node):
        ...
        self.fromXmlImpl(node, KalturaAudioDescriptionVendorTaskData.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaVendorTaskData.toParams(self)
        kparams.put("objectType", "KalturaAudioDescriptionVendorTaskData")
        return kparams
...
class KalturaCaptionVendorTaskData(KalturaVendorTaskData):
    ...
    def fromXml(self, node):
        KalturaVendorTaskData.fromXml(self, node)
        self.fromXmlImpl(node, KalturaCaptionVendorTaskData.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaVendorTaskData.toParams(self)
        kparams.put("objectType", "KalturaCaptionVendorTaskData")
        return kparams
...
class KalturaDubbingVendorTaskData(KalturaVendorTaskData):
    ...
    def fromXml(self, node):
        KalturaVendorTaskData.fromXml(self, node)
        self.fromXmlImpl(node, KalturaDubbingVendorTaskData.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaVendorTaskData.toParams(self)
        kparams.put("objectType", "KalturaDubbingVendorTaskData")
        return kparams
...
class KalturaSignLanguageVendorTaskData(KalturaVendorTaskData):
    ...
    def fromXml(self, node):
        KalturaVendorTaskData.fromXml(self, node)
        self.fromXmlImpl(node, KalturaSignLanguageVendorTaskData.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaVendorTaskData.toParams(self)
        kparams.put("objectType", "KalturaSignLanguageVendorTaskData")
        kparams.addStringIfDefined("assetId", self.assetId)
        return kparams
...
# @package Kaltura
# @subpackage Client
class KalturaVendorAvatarVodCatalogItem(KalturaVendorCatalogItem):
    def __init__(self,
            id = NotImplemented,
            vendorPartnerId = NotImplemented,
            name = NotImplemented,
    ...
    def fromXml(self, node):
        KalturaVendorCatalogItem.fromXml(self, node)
        self.fromXmlImpl(node, KalturaVendorAvatarVodCatalogItem.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaVendorCatalogItem.toParams(self)
        kparams.put("objectType", "KalturaVendorAvatarVodCatalogItem")
        return kparams
...
# @package Kaltura
# @subpackage Client
class KalturaVendorAvatarVodCatalogItemFilter(KalturaVendorCatalogItemFilter):
    def __init__(self,
            orderBy = NotImplemented,
            advancedSearch = NotImplemented,
            idEqual = NotImplemented,
    ...
    def fromXml(self, node):
        ...
        self.fromXmlImpl(node, KalturaVendorAvatarVodCatalogItemFilter.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaVendorCatalogItemFilter.toParams(self)
        kparams.put("objectType", "KalturaVendorAvatarVodCatalogItemFilter")
        return kparams
...
class KalturaReachClientPlugin(KalturaClientPlugin):
    ...
    def getTypes(self):
        return {
            ...
            'KalturaEntryVendorTaskUnit': KalturaEntryVendorTaskUnit,
            ...
            'KalturaVendorCatalogItemUnitPricing': KalturaVendorCatalogItemUnitPricing,
            'KalturaVendorCatalogItem': KalturaVendorCatalogItem,
            'KalturaAddEntryVendorTaskAction': KalturaAddEntryVendorTaskAction,
            'KalturaAudioDescriptionVendorTaskData': KalturaAudioDescriptionVendorTaskData,
            'KalturaCaptionVendorTaskData': KalturaCaptionVendorTaskData,
            ...
            'KalturaDubbingVendorTaskData': KalturaDubbingVendorTaskData,
            ...
            'KalturaSignLanguageVendorTaskData': KalturaSignLanguageVendorTaskData,
            ...
            'KalturaVendorAvatarVodCatalogItem': KalturaVendorAvatarVodCatalogItem,
            ...
            'KalturaVendorAvatarVodCatalogItemFilter': KalturaVendorAvatarVodCatalogItemFilter,
