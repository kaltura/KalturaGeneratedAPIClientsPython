...
class KalturaSynacorHboDistributionProfile(KalturaConfigurableDistributionProfile):
    ...
    def __init__(self,
            ...
            feedSubtitle: str = NotImplemented,
            feedLink: str = NotImplemented,
            feedAuthorName: str = NotImplemented): ...

    def getFeedUrl(self) -> str: ...
    def getFeedTitle(self) -> str: ...
    def setFeedTitle(self, newFeedTitle: str) -> None: ...
    def getFeedSubtitle(self) -> str: ...
    def setFeedSubtitle(self, newFeedSubtitle: str) -> None: ...
    def getFeedLink(self) -> str: ...
    def setFeedLink(self, newFeedLink: str) -> None: ...
    def getFeedAuthorName(self) -> str: ...
    def setFeedAuthorName(self, newFeedAuthorName: str) -> None: ...
...
class KalturaSynacorHboDistributionClientPluginServicesProxy:
