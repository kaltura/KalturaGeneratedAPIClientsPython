...
class KalturaBulkService(KalturaServiceBase):
    ...
    def list(self, bulkUploadFilter: KalturaBulkUploadFilter = NotImplemented, pager: KalturaFilterPager = NotImplemented) -> KalturaBulkUploadListResponse: ...
    def serve(self, id: int) -> IO[Any]: ...
    def serveLog(self, id: int) -> IO[Any]: ...

class KalturaBulkUploadClientPluginServicesProxy:
