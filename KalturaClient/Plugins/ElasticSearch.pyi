...
class KalturaESearchScoreFunctionParams(KalturaObjectBase):
    ...
    decay: float
    def __init__(self,
            decayAlgorithm: KalturaESearchScoreFunctionDecayAlgorithm = NotImplemented,
            functionField: KalturaESearchScoreFunctionField = NotImplemented,
            boostMode: KalturaESearchScoreFunctionBoostMode = NotImplemented,
            origin: KalturaESearchScoreFunctionOrigin = NotImplemented,
            weight: float = NotImplemented,
            scale: str = NotImplemented,
            decay: float = NotImplemented): ...

    def getDecayAlgorithm(self) -> KalturaESearchScoreFunctionDecayAlgorithm: ...
    def setDecayAlgorithm(self, newDecayAlgorithm: KalturaESearchScoreFunctionDecayAlgorithm) -> None: ...
    def getFunctionField(self) -> KalturaESearchScoreFunctionField: ...
    def setFunctionField(self, newFunctionField: KalturaESearchScoreFunctionField) -> None: ...
    def getBoostMode(self) -> KalturaESearchScoreFunctionBoostMode: ...
    def setBoostMode(self, newBoostMode: KalturaESearchScoreFunctionBoostMode) -> None: ...
    def getOrigin(self) -> KalturaESearchScoreFunctionOrigin: ...
    def setOrigin(self, newOrigin: KalturaESearchScoreFunctionOrigin) -> None: ...
    def getWeight(self) -> float: ...
    def setWeight(self, newWeight: float) -> None: ...
    def getScale(self) -> str: ...
    def setScale(self, newScale: str) -> None: ...
    def getDecay(self) -> float: ...
    def setDecay(self, newDecay: float) -> None: ...
...
class KalturaESearchParams(KalturaObjectBase):
    ...
    def __init__(self,
            ...
            scoreFunctionParams: KalturaESearchScoreFunctionParams = NotImplemented): ...
    ...
    def getScoreFunctionParams(self) -> KalturaESearchScoreFunctionParams: ...
    def setScoreFunctionParams(self, newScoreFunctionParams: KalturaESearchScoreFunctionParams) -> None: ...
