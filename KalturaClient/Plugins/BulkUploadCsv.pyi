...
class KalturaBulkUploadCsvJobData(KalturaBulkUploadJobData):
    ...
    def __init__(self,
            ...
            processObjectId: str = NotImplemented,
            processObjectType: str = NotImplemented): ...
    ...
    def getProcessObjectId(self) -> str: ...
    def setProcessObjectId(self, newProcessObjectId: str) -> None: ...
    def getProcessObjectType(self) -> str: ...
    def setProcessObjectType(self, newProcessObjectType: str) -> None: ...

class KalturaBulkUploadCsvClientPluginServicesProxy: