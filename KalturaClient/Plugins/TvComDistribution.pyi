...
class KalturaTVComDistributionProfile(KalturaConfigurableDistributionProfile):
    ...
    def __init__(self,
            ...
            feedLanguage: str = NotImplemented,
            feedCopyright: str = NotImplemented,
            feedImageTitle: str = NotImplemented,
            feedImageUrl: str = NotImplemented,
            feedImageLink: str = NotImplemented,
            feedImageWidth: int = NotImplemented,
            feedImageHeight: int = NotImplemented): ...
    ...
    def getFeedLanguage(self) -> str: ...
    def setFeedLanguage(self, newFeedLanguage: str) -> None: ...
    def getFeedCopyright(self) -> str: ...
    def setFeedCopyright(self, newFeedCopyright: str) -> None: ...
    def getFeedImageTitle(self) -> str: ...
    def setFeedImageTitle(self, newFeedImageTitle: str) -> None: ...
    def getFeedImageUrl(self) -> str: ...
    def setFeedImageUrl(self, newFeedImageUrl: str) -> None: ...
    def getFeedImageLink(self) -> str: ...
    def setFeedImageLink(self, newFeedImageLink: str) -> None: ...
    def getFeedImageWidth(self) -> int: ...
    def setFeedImageWidth(self, newFeedImageWidth: int) -> None: ...
    def getFeedImageHeight(self) -> int: ...
    def setFeedImageHeight(self, newFeedImageHeight: int) -> None: ...
...
class KalturaTvComDistributionClientPluginServicesProxy: