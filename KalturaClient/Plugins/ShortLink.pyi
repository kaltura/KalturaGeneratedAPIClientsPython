...
class KalturaShortLink(KalturaObjectBase):
    ...
    def setUniqueId(self, newUniqueId: str) -> None: ...
...
class KalturaShortLinkBaseFilter(KalturaFilter):
    ...
    def __init__(self,
            ...
            uniqueIdEqual: str = NotImplemented): ...
    ...
    def getUniqueIdEqual(self) -> str: ...
    def setUniqueIdEqual(self, newUniqueIdEqual: str) -> None: ...
