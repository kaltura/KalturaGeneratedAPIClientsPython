...
class KalturaEntryVendorTask(KalturaObjectBase):
    ...
    def __init__(self,
            ...
            externalObjectId: str = NotImplemented): ...
    ...
    def getExternalObjectId(self) -> str: ...
    def setExternalObjectId(self, newExternalObjectId: str) -> None: ...
...
class KalturaReachProfile(KalturaObjectBase):
    ...
    def __init__(self,
            ...
            allowedCatalogItemIds: str = NotImplemented): ...
    ...
    def setUsedCredit(self, newUsedCredit: float) -> None: ...
    ...
    def getAllowedCatalogItemIds(self) -> str: ...
    def setAllowedCatalogItemIds(self, newAllowedCatalogItemIds: str) -> None: ...
...
class KalturaVendorCatalogItem(KalturaObjectBase):
    ...
    def getPayPerUse(self) -> bool: ...
    def setPayPerUse(self, newPayPerUse: bool) -> None: ...
...
class KalturaImmersiveAgentCallVendorTaskData(KalturaVendorTaskData):
    ...
    def setCallId(self, newCallId: str) -> None: ...
...
class KalturaMetadataEnrichmentVendorTaskData(KalturaLocalizedVendorTaskData):
    ...
    def __init__(self,
            ...
            instruction: str = NotImplemented,
            shouldApply: bool = NotImplemented,
            applyMode: KalturaMetadataEnrichmentApplyMode = NotImplemented,
            overrideFields: List[KalturaString] = NotImplemented): ...

    def getDetailLevel(self) -> str: ...
    def setDetailLevel(self, newDetailLevel: str) -> None: ...
    def getInstruction(self) -> str: ...
    def setInstruction(self, newInstruction: str) -> None: ...
    def getShouldApply(self) -> bool: ...
    def setShouldApply(self, newShouldApply: bool) -> None: ...
    def getApplyMode(self) -> KalturaMetadataEnrichmentApplyMode: ...
    def setApplyMode(self, newApplyMode: KalturaMetadataEnrichmentApplyMode) -> None: ...
    def getOverrideFields(self) -> List[KalturaString]: ...
    def setOverrideFields(self, newOverrideFields: List[KalturaString]) -> None: ...
...
class KalturaVendorCatalogItemService(KalturaServiceBase):
    ...
    def serve(self, vendorPartnerId: int = NotImplemented, filter: KalturaVendorCatalogItemFilter = NotImplemented) -> IO[Any]: ...
