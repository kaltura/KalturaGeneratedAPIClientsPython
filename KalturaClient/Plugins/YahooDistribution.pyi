...
class KalturaYahooDistributionJobProviderData(KalturaConfigurableDistributionJobProviderData):
    ...
    def __init__(self,
            ...
            smallThumbPath: str = NotImplemented,
            largeThumbPath: str = NotImplemented,
            videoAssetFilePath: str = NotImplemented): ...

    def getSmallThumbPath(self) -> str: ...
    def setSmallThumbPath(self, newSmallThumbPath: str) -> None: ...
    def getLargeThumbPath(self) -> str: ...
    def setLargeThumbPath(self, newLargeThumbPath: str) -> None: ...
...
class KalturaYahooDistributionProfile(KalturaConfigurableDistributionProfile):
    ...
    def __init__(self,
            ...
            contactTelephone: str = NotImplemented,
            contactEmail: str = NotImplemented,
            processFeed: KalturaYahooDistributionProcessFeedActionStatus = NotImplemented): ...
    ...
    def getContactTelephone(self) -> str: ...
    def setContactTelephone(self, newContactTelephone: str) -> None: ...
    def getContactEmail(self) -> str: ...
    def setContactEmail(self, newContactEmail: str) -> None: ...
    def getProcessFeed(self) -> KalturaYahooDistributionProcessFeedActionStatus: ...
    def setProcessFeed(self, newProcessFeed: KalturaYahooDistributionProcessFeedActionStatus) -> None: ...
...
class KalturaYahooDistributionClientPluginServicesProxy: