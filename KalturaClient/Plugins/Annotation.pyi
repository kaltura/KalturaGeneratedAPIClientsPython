...
class KalturaAnnotation(KalturaCuePoint):
    ...
    def __init__(self,
            ...
            originalCuePointCreateAt: int = NotImplemented): ...
    ...
    def getOriginalCuePointCreateAt(self) -> int: ...
    def setOriginalCuePointCreateAt(self, newOriginalCuePointCreateAt: int) -> None: ...
