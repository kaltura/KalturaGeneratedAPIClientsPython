...
# @package Kaltura
# @subpackage Client
class KalturaAvnDistributionProfileOrderBy(object):
...
# @package Kaltura
# @subpackage Client
class KalturaAvnDistributionProviderOrderBy(object):
...
class KalturaAvnDistributionProvider(KalturaDistributionProvider):
    ...
    def fromXml(self, node):
        ...
        self.fromXmlImpl(node, KalturaAvnDistributionProvider.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaDistributionProvider.toParams(self)
        kparams.put("objectType", "KalturaAvnDistributionProvider")
        return kparams
...
class KalturaAvnDistributionProfile(KalturaConfigurableDistributionProfile):
    ...
    def fromXml(self, node):
        ...
        self.fromXmlImpl(node, KalturaAvnDistributionProfile.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaConfigurableDistributionProfile.toParams(self)
        kparams.put("objectType", "KalturaAvnDistributionProfile")
...
class KalturaAvnDistributionProviderBaseFilter(KalturaDistributionProviderFilter):
    ...
    def fromXml(self, node):
        ...
        self.fromXmlImpl(node, KalturaAvnDistributionProviderBaseFilter.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaDistributionProviderFilter.toParams(self)
        kparams.put("objectType", "KalturaAvnDistributionProviderBaseFilter")
        return kparams
...
class KalturaAvnDistributionProviderFilter(KalturaAvnDistributionProviderBaseFilter):
    def __init__(self,
            ...
            typeEqual=NotImplemented,
            typeIn=NotImplemented):
        KalturaAvnDistributionProviderBaseFilter.__init__(self,
            orderBy,
            advancedSearch,
            typeEqual,
            typeIn)
    ...
    def fromXml(self, node):
        KalturaAvnDistributionProviderBaseFilter.fromXml(self, node)
        self.fromXmlImpl(node, KalturaAvnDistributionProviderFilter.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaAvnDistributionProviderBaseFilter.toParams(self)
        kparams.put("objectType", "KalturaAvnDistributionProviderFilter")
        return kparams
...
class KalturaAvnDistributionProfileBaseFilter(KalturaConfigurableDistributionProfileFilter):
    ...
    def fromXml(self, node):
        ...
        self.fromXmlImpl(node, KalturaAvnDistributionProfileBaseFilter.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaConfigurableDistributionProfileFilter.toParams(self)
        kparams.put("objectType", "KalturaAvnDistributionProfileBaseFilter")
        return kparams
...
class KalturaAvnDistributionProfileFilter(KalturaAvnDistributionProfileBaseFilter):
    def __init__(self,
            ...
            statusEqual=NotImplemented,
            statusIn=NotImplemented):
        KalturaAvnDistributionProfileBaseFilter.__init__(self,
            orderBy,
            advancedSearch,
            idEqual,
            idIn,
    ...
    def fromXml(self, node):
        KalturaAvnDistributionProfileBaseFilter.fromXml(self, node)
        self.fromXmlImpl(node, KalturaAvnDistributionProfileFilter.PROPERTY_LOADERS)

    def toParams(self):
        kparams = KalturaAvnDistributionProfileBaseFilter.toParams(self)
        kparams.put("objectType", "KalturaAvnDistributionProfileFilter")
        return kparams


########## services ##########
########## main ##########
class KalturaAvnDistributionClientPlugin(KalturaClientPlugin):
    # KalturaAvnDistributionClientPlugin
    instance = None

    # @return KalturaAvnDistributionClientPlugin
    @staticmethod
    def get():
        if KalturaAvnDistributionClientPlugin.instance == None:
            KalturaAvnDistributionClientPlugin.instance = KalturaAvnDistributionClientPlugin()
        return KalturaAvnDistributionClientPlugin.instance
    ...
    def getEnums(self):
        return {
            'KalturaAvnDistributionProfileOrderBy': KalturaAvnDistributionProfileOrderBy,
            'KalturaAvnDistributionProviderOrderBy': KalturaAvnDistributionProviderOrderBy,
        }

    def getTypes(self):
        return {
            'KalturaAvnDistributionProvider': KalturaAvnDistributionProvider,
            'KalturaAvnDistributionProfile': KalturaAvnDistributionProfile,
            'KalturaAvnDistributionProviderBaseFilter': KalturaAvnDistributionProviderBaseFilter,
            'KalturaAvnDistributionProviderFilter': KalturaAvnDistributionProviderFilter,
            'KalturaAvnDistributionProfileBaseFilter': KalturaAvnDistributionProfileBaseFilter,
            'KalturaAvnDistributionProfileFilter': KalturaAvnDistributionProfileFilter,
        }
